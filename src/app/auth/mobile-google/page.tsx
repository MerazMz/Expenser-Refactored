    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#090a0d] text-white p-6 font-sans">
      <div className="w-full max-w-sm rounded-3xl bg-[#13151b] border border-[#232733] p-8 text-center shadow-2xl">
        ...
        <button
          ...
          disabled={status === "authenticating" || status === "redirecting"}
          className="w-full flex items-center justify-center space-x-3 py-3 px-4 rounded-xl bg-white text-zinc-900 font-bold text-sm hover:bg-zinc-100 active:scale-[0.98] transition-all cursor-pointer shadow-md disabled:opacity-60"
        >
